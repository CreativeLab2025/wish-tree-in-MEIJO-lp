...
const CreativeLabLanding: React.FC = () => {
  ...
  const handleARClick = () => {
    ...
    if(window.confirm("🌳 AR体験を開始します！\n\nスマートフォンでQRコードをスキャンして、\n魔法の森での願いの体験をお楽しみください！")) {
      window.location.href = "https://a7c709bd8114.ngrok-free.app/";
    }
  };
      ...
      <div className="h-screen flex flex-col">
        ...
        <div className="bg-[#FF9600] px-4 py-2">
          <div className="flex gap-2 items-center flex-wrap">
            ...
            <a className="text-xs bg-white text-gray-800 px-3 py-1 rounded-full cursor-pointer hover:bg-gray-100 hover:shadow-lg transition-all duration-200" href="https://a7c709bd8114.ngrok-free.app/">
